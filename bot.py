...
#شناسه اکانت
bot = Robot_Rubika("xffmaicbkrrlofhuysquscwmenjpriai")
#......
#شناسه گروه
target = "g0BbWVQ04efc221bc358b350870b9808"
#......
#شناسه کانال
channell = "c0BHMrc045e43034698bc7bd5d55bb1a"
#......
#شناسه کانال مورد نظر برای تبلیغات
channell_sin_tabl = "c0BLIIe05ea02903ff06b206207d22bb"
...
# static variable
answered, sleeped, retries,forward_Channell, answer,lock_fosh,st,list_gap,sttab2,st_tabl = [] , False , {} , True , [] , False , False , [] , False , False
			...
			try:
				if msg["type"]=="Text" and not msg.get("message_id") in answered:
					...
					if not sleeped:
						if hasAds(msg.get("text")) and not msg.get("author_object_guid") in admins :
						...
						elif msg.get("text").startswith("سین بزن") and msg.get("author_object_guid") in admins:
							while(1):
								try:
									if sin_time != False:
							...
							try:
								...
								bot.sendmovie(target, "video_robot/ARIANBOT.mp4", message_id=msg.get("message_id"))
							except:
								print("err send_GIF")
